...
import { AnchorNode, FieldKey, TreeValue } from "../core/index.js";
...
import { ObjectNodeSchema, isObjectNodeSchema } from "./objectNode.js";
import { NodeFromSchema } from "./schemaTypes.js";
import { getSimpleNodeSchema } from "./schemaCaching.js";
import { TreeIndexNodes } from "../feature-libraries/indexing/types.js";
import { hasElement } from "../feature-libraries/indexing/anchorTreeIndex.js";
...
function getOrCreateSimpleTree(context: Context, anchorNode: AnchorNode): TreeNode | TreeValue {
	return (
